  ...
  <div v-if="lessonStore.activeLesson" class="max-w-4xl mx-auto p-8 pb-32">
    <div class="flex justify-between items-center mb-8">
      ...
      >
        <Icon
          :name="
            lessonStore.isFavorite(lessonStore.activeLesson.id) ? 'lucide:star' : 'lucide:star'
          "
          :class="
            lessonStore.isFavorite(lessonStore.activeLesson.id)
              ? 'text-yellow-400'
              : 'text-slate-600'
          "
    ...
    <div class="transition-all duration-300">
      ...
      <div
        v-if="lessonStore.activeTab === 'Vocabulary'"
      ...
      >
        ...
        >
          <div class="flex items-center gap-2 mb-2">
            ...
            <span class="text-blue-400 font-black text-lg"
              >{{ item.word }} - <span class="text-blue-300">{{ item.ipa }}</span></span
            >
          </div>
      ...
      <div
        v-if="lessonStore.activeTab === 'Sample Sentences'"
        class="bg-[#16181d] p-8 rounded-3xl border border-white/5 relative overflow-hidden"
      >
      ...
      <div
        v-if="lessonStore.activeTab === 'Exercises'"
        class="bg-[#10172a] p-8 rounded-3xl border border-white/5 relative overflow-hidden"
      >
